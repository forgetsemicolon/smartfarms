...
<?php 
    ...
    $lines = file("welcome.txt", FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    $data = array_map(function($v){
        list($moist, $waterl, $temp, $humidity) = explode(":", $v);
        return ["moisture" => $moist, "waterlevel" => $waterl, "temperature" => $temp, "humidity" => $humidity];
    }, $lines);
?>
...
<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> SOIL &amp; MOISTURE</span></td>
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo $user["moisture"];?> </span></td>
</tr>


<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> TEMPERATURE</span></td>
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $user["temperature"];?> </span></td>
</tr>


<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> HUMIDITY</span></td>
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $user["humidity"];?> </span></td>
</tr>


<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> % of WATER LEVEL IN TANK</span></td>
<td class="cell1"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo $user["waterlevel"];?> </span></td>
</tr>
    <?php }?>
</table>
...
<input type="submit" id="Button1" name="Crop Rotation" value="Crop Rotation" style="position:absolute;left:546px;top:649px;width:289px;height:25px;z-index:7;">
    ...
    <a href="Ksmartfarm/kdashboard.html">ಕನ್ನಡ</a> 
