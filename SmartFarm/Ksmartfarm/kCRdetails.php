...
tr:nth-child(even) {
    ...
    <body>
        ...
        <h1><center>ಬೆಳೆ ತಿರುಗುವಿಕೆ</center></h1>
        </div>
        <div>
        <form name = "ss" >
            <button name="potato" value="potato"  type = "submit" img = "images/builtwithwwb12.png">ಆಲೂಗಡ್ಡೆ</button>
            <button name="onion" value="onion" type = "submit" >ಈರುಳ್ಳಿ</button>
            <button name="beans" value="beans" type = "submit" >ಬೀನ್ಸ್</button>
            <button name="cabbage" value="cabbage" type = "submit" >ಎಲೆಕೋಸು</button>
        </form>
        </div>
